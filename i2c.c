...
#include "i2c.h"
 ...
 defined (__AVR_ATmega48P__)    || defined (__AVR_ATmega1284P__) || \
 defined (__AVR_ATmega324A__)   || defined (__AVR_ATmega324P__)  || \
 defined (__AVR_ATmega324PA__)  || defined (__AVR_ATmega644__)   || \
...
/*----------------------------------------------------------------------------
 ...
 Return Value: uint8_t
  - TWDR: recieved value at I2C-Interface, 0 at timeout
  - 0:    Error at read
-----------------------------------------------------------------
*/
...
/*----------------------------------------------------------------------------
 ...
 Purpose: read non-acknowledge from I2C Interface
